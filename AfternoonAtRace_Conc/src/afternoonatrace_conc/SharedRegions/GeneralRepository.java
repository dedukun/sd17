...
public class GeneralRepository {
    ...
    */
    public synchronized void updateLog(){
        ...
        log.writelnString(" "+raceNumber+"  "+String.format("%2s",trackSize)+"   "+betS[0]+"  "+String.format("%4s",betA[0])+"  "+betS[1]+"  "+String.format("%4s",betA[1])+"  "+betS[2]+"  "+String.format("%4s",betA[2])+"  "+betS[3]+"  "+String.format("%4s",betA[3])+" "+String.format("%4s",String.format("%.1f",odds[0]))+" "+String.format("%2s",horseIteration[0])+"  "+horsePosition[0]+"   "+horseEnd[0]+" "+String.format("%4s",String.format("%.1f",odds[1]))+" "+String.format("%2s",horseIteration[1])+"  "+horsePosition[1]+"   "+horseEnd[1]+" "+String.format("%4s",String.format("%.1f",odds[2]))+" "+String.format("%2s",horseIteration[2])+"  "+horsePosition[2]+"   "+horseEnd[2]+" "+String.format("%4s",String.format("%.1f",odds[3]))+" "+String.format("%2s",horseIteration[3])+"  "+horsePosition[3]+"   "+horseEnd[3]);  
